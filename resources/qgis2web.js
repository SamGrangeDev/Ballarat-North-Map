...
map.getView().fit([16007045.424596, -4511883.720025, 16015119.926951, -4507711.721054], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Ballarat North Map</h2>';
        return titleElement;
    })(),
